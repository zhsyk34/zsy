...
import com.cat.zsy.hb.domain.*;
import com.cat.zsy.hb.dto.MerchandiseDTO;
import com.cat.zsy.hb.dto.OrdersDTO;
...
public class CriteriaTest extends SpringTest {
    ...
    public void find() throws Exception {
        System.out.println(manager.find(Merchandise.class, 37L));
    }
    ...
    public void find2() throws Exception {
        ...
        Predicate predicate = builder.equal(root.get(User_.name), "李白");
